const planData = [
    {
        ...
        items: [
            ...
            {
                id: 13,
                name: 'Центр по работе с филиалами',
                fact: 20,
                plan: 10000,
                isIncrease: true,
                currentMonth: 8,
            ...
            {
                id: 15,
                name: 'Научный центр стратегического планирования',
                fact: 70,
                plan: 2000,
                isIncrease: true,
                currentMonth: 8,
            ...
            {
                id: 18,
                name: 'Отдел контроля учебного процесса',
                fact: 70,
                plan: 2000,
                isIncrease: true,
                currentMonth: 8,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    class Partner {
        ...
        bg(index) {
            let bgOffsetModifier = null
            if (index > 0 && index < 3) {
                bgOffsetModifier = 'small'
            }

            return `
                <svg class="plan__tabcontent-block__bg_${bgOffsetModifier} hide" viewBox="0 0 1269 675" fill="none" xmlns="http://www.w3.org/2000/svg">
