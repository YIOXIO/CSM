document.addEventListener('DOMContentLoaded', () => {
    ...
    function inWork(value, expired) {
        return `
        <div class="gph__tabcontent-block__in-work ${expired > 0 ? '' : 'gph__tabcontent-block__in-work_short'}">
            <span class="gph__tabcontent-block__title">В работе</span>
            <span class="gph__tabcontent-block__value">${value}</span>
        </div>
        `
        ...
        <div class="modal__body">
            ...
            <div class="gph__tabcontent-block__item data-id="${item.id}">
                <div class="gph__tabcontent-block__content">
                    ...
                    <div class="gph__tabcontent-block__descr">${item.name}</div>
                    <div class="gph__tabcontent-block__info">
                        ${item.inWork > 0 ? inWork(item.inWork, item.expired) : ''}
            ...
            <diV class="gph__tabcontent-block__table gph__tabcontent-block__table-body ${item.projects.length >= 9 ? 'gph__tabcontent-block__table-body_scroll' : ''}">
