document.addEventListener('DOMContentLoaded', () => {
            ...
            <div class="modal__body">
                ...
                <div class="modal__block modal__block_right">
                    ...
                    <div class="modal__block-item">
                        ...
                        <div class="modal__block-item__descr">тел.: <span class="modal__block-item__phone">${phone}</span></div>
                    </div>
                </div>
                </div>
    ...
    console.log(document.querySelectorAll('.partners__tabcontent-block__item'))
